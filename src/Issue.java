...
PreparedStatement pst; 
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 0, 204), 2), "Issue Panel", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 24), new java.awt.Color(102, 0, 102))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String sql="select * from Book where Track_ID=? and Title=?";
        try{
            ...
            if(rs.next()){
                ...
                String add6=rs.getString("Owner");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        //Issue button
         String sql="insert into Borrow_Table(Track_ID,Title,Edition,Author,Genre,Student_ID,Name,Phone,Semester,Email,DateOfIssue,Owner) values(?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            pst=conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
            pst.setString(2, jTextField2.getText());
        ...
        try{
            ...
            if(rs.next()){
               String add1=rs.getString("Name");
                ...
                JOptionPane.showMessageDialog(null, "Student ID not found or ID password do not match");
            }
